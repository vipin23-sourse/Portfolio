...
const skillGroups = [
  ...
  },
  {
    ...
    skills: ["Claude AI", "Gemini", "GitHub Copilot", "MCP", "Prompt Engineering", "OpenAI APIs", "Automation Workflows"],
  },
  {
...
function SkillBadge({ skill }: { skill: string }) {
  return (
    <span className="inline-flex px-3 py-1.5 rounded-lg text-sm font-medium bg-secondary border border-border text-foreground hover:border-primary/40 hover:bg-accent hover:text-accent-foreground transition-all duration-200 cursor-default">
      {skill}
    </span>
  );
}
